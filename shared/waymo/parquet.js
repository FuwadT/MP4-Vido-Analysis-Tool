...
export async function openParquetFileFromAsyncBuffer(component, buffer) {
    const cachedBuffer = cachedAsyncBuffer(buffer);
    const metadata = await parquetMetadataAsync(cachedBuffer);
