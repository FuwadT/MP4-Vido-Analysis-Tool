    ...
    const shortcuts = [
        {
            ...
            items: [
                ...
                { keys: ['Right Arrow'], description: 'Forward 0.1s (1 frame)' },
                { keys: ['Left Arrow'], description: 'Backward 0.1s (1 frame)' },
                { keys: ['Shift', 'Right Arrow'], description: 'Forward 1 second' },
                { keys: ['Shift', 'Left Arrow'], description: 'Backward 1 second' },
        ...
        },
        {
            ...
            items: [
                ...
                { keys: ['Ctrl', 'Right Arrow'], description: 'Next event marker' },
                { keys: ['Ctrl', 'Left Arrow'], description: 'Previous event marker' },
